...
namespace NewsService.Migrations
{
    ...
    [Migration("20220621131623_DBInitial")]
            ...
            modelBuilder.Entity("NewsService.Model.News", b =>
                {
                    ...
                    b.Property<int?>("NewsCategoryId1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NewsService.Model.News", b =>
                {
                    ...
                    b.HasOne("NewsService.Model.NewsCategory", null)
                        .WithMany("News")
                        .HasForeignKey("NewsCategoryId1");
